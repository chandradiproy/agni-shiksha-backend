...
exports.getAiInsights = exports.getHomeDashboard = void 0;
...
const getHomeDashboard = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const [recommendedTests, currentAffairs, dailyQuests] = yield Promise.all([
            // Cache tests specific to the user's selected exam for 10 minutes
            fetchWithVersionedCache('tests', `dashboard:tests:${examId}`, 600, () => {
                if (examId === 'unassigned')
                    return Promise.resolve([]);
                return db_1.default.testSeries.findMany({
            ...
            fetchWithVersionedCache('articles', 'dashboard:articles:latest', 900, () => {
                return db_1.default.article.findMany({
            ...
            fetchWithVersionedCache('quests', 'dashboard:quests:active', 3600, () => {
                return db_1.default.questConfig.findMany({
...
const getAiInsights = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const cachedInsights = yield cache_service_1.CacheService.get('ai-insights', cacheScope);
        if (cachedInsights) {
            return res.status(200).json({ success: true, data: cachedInsights });
        }
        // Fetch user's last 10 test attempts to analyze performance
        const recentAttempts = yield db_1.default.testAttempt.findMany({
            ...
            if (attempt.subject_scores && typeof attempt.subject_scores === 'object') {
                Object.entries(attempt.subject_scores).forEach(([subject, score]) => {
                    if (!subjectAggregates[subject])
                        subjectAggregates[subject] = { totalScore: 0, count: 0 };
        ...
        yield cache_service_1.CacheService.set('ai-insights', cacheScope, insightsPayload, 1800);
